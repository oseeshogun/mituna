...
class OfflineQuestionsLoadScreen extends HookWidget {
  ...
  Widget build(BuildContext context) {
    ...
    final animation = useAnimation(Tween<Alignment>(
        ...
        try {
          ...
          if (context.mounted)
            showOkAlertDialog(
                context: context,
                title:
                    'Une erreur est survenue pendant le chargement des questions.');
            ...
            children: [
              ...
              Container(
                width: MediaQuery.of(context).size.width -
                    AppSizes.kScaffoldHorizontalPadding * 2,
                height: 10,
                decoration: BoxDecoration(
                    borderRadius: BorderRadius.circular(10.0),
                    color: AppColors.kColorChambray),
