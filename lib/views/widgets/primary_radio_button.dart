...
class PrimaryRadioButton<T> extends StatelessWidget {
  const PrimaryRadioButton({
    ...
    this.selectedTextColor = kColorBlack,
    this.fillColor = Colors.transparent,
    this.selectedFillColor = kColorYellow,
    this.borderColor = Colors.white,
    this.selectedBorderColor = kColorYellow,
    this.radioBorderColor = Colors.white,
    this.selectedRadioBorderColor = kColorBlueRibbon,
    this.radioFillColor = Colors.transparent,
    this.selectedRadioFillColor = kColorBlueRibbon,
    Key? key,
  }) : super(key: key);
